...
function switchContext() {
  return new Promise((resolve, reject) => {
    ...
    const isDev = /\<\!\--\s\<MainPath\>\.\/dist\/index\.html\<\/MainPath\>\s\-\-\>/gm;
    const isBuild = /\<\!\--\s\<MainPath\>\.\/public\/index\-dev\.html\<\/MainPath\>\s\-\-\>/gm;
    const isDevVanilla = /\<MainPath\>\.\/dist\/index\.html\<\/MainPath\>/gm;
    const isBuildVanilla = /\<MainPath\>\.\/public\/index\-dev\.html\<\/MainPath\>/gm;
